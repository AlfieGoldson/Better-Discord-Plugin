...
export default class DOMTools {
    static get Selector(): any;
    static get ClassName(): any;
    static get DOMObserver(): any;
    /**
     * Default DOMObserver for global usage.
     *
     * @see DOMObserver
     */
    static get observer(): any;
    /**
     ...
     */
    static queryAll(selector: string, baseElement?: Element): Array<Element>;
    /**
     ...
     */
    static parents(element: Element, selector?: string): Array<Element>;
    /**
     ...
     * @returns {Array<Element>} - The list of siblings
     */
    static siblings(element: Element, selector?: string): Array<Element>;
    /**
     ...
     */
    static offset(element: Element): any;
     ...
     */
    static on(element: Element, event: string, delegate: (string | any), callback?: any): any;
    /**
     ...
     * @returns {module:DOMTools~CancelListener} - A function that will undo the listener
     */
    static once(element: Element, event: string, delegate: (string | any), callback?: any): any;
     ...
     */
    static off(element: (Element | string), event?: string, delegate?: (string | any), callback?: any): Element;
    /**
     ...
     */
    static onMountChange(node: HTMLElement, callback: any, onMount?: boolean): HTMLElement;
     ...
     */
    static resolveElement(node: (any | Element)): any;
}
/**
