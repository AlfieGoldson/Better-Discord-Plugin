...
// export type DiscordModulesProxy = typeof Proxy<DiscordModules>;

declare class DiscordModules {
    ...
    get MessageParser() {
        return WebpackModules.getModule(
            (m) => Object.keys(m).length && Object.keys(m).every((k) => k === 'parse' || k === 'unparse'),
        );
    },
    ...
    get UserPopout() {
        return WebpackModules.getByDisplayName('ConnectedUserPopout');
    },
    ...
    get TextElement() {
        return WebpackModules.getByDisplayName('Text');
    },
    get Anchor() {
    ...
    get ColorPicker() {
        return WebpackModules.getByDisplayName('ColorPicker');
    }, // Loaded by Discord on demand
    get Dropdown() {
        return WebpackModules.getModule(
            (m) =>
                m.prototype &&
