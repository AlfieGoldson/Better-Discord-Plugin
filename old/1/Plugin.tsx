    ...
    return class Corehalla extends DiscordPlugin {
                ...
                children.splice(
                    ...
                    BDFDB.ContextMenuUtils.createItem(BDFDB.LibraryComponents.MenuItems.MenuGroup, {
                        children: BDFDB.ContextMenuUtils.createItem(BDFDB.LibraryComponents.MenuItems.MenuItem, {
                            label: 'Corehalla',
                            id: BDFDB.ContextMenuUtils.createItemId(this.name, 'blabla'),
                            action: () => {
        ...
        openUserSettingsModal(user) {
            BDFDB.ModalUtils.open(this, {
                ...
                children: [
                    <BDFDB.LibraryComponents.ModalComponents.ModalTabContent tab="Stats" key="Stats">
                        <div>
                    ...
                    <BDFDB.LibraryComponents.ModalComponents.ModalTabContent tab="XD" key="XD">
                        <div>
                            <BDFDB.LibraryComponents.Flex>Ranked</BDFDB.LibraryComponents.Flex>
                        </div>
                    </BDFDB.LibraryComponents.ModalComponents.ModalTabContent>,
                ],
            });
